...
const AboutPage: React.FC = () => {
  ...
  return (
    <div style={{ minHeight: '100vh', backgroundColor: 'white' }}>
      ...
      >
        ...
        <div style={{ 
          ...
          <div style={{ 
            ...
            <div>음식은</div>
            <div style={{ color: '#f97316' }}>{text}</div>
            <div style={{ color: '#f97316' }}>파는 사람도</div>
            <div>건강해야 한다</div>
          </div>
      ...
      {/* 글로벌 K-푸드 시대를 이끄는 외식문화 선도기업 OM FOOD Section */}
      <motion.section 
      ...
      >
        <div style={{ maxWidth: '80rem', margin: '0 auto' }}>
          <h2 style={{ 
            ...
            글로벌 K-푸드 시대를 이끄는 외식문화 선도기업 OM FOOD
          </h2>
          ...
          <div style={{ 
            ...
            <div style={{ 
              ...
              <p>
                OM FOOD는 건강하고 정직한 식문화를 통해 고객의 일상에 따뜻한 가치를 더하는 것을 목표로 합니다.
              </p>
              <p>
                기름에 튀기지 않고 오븐에 구워내는 등 본사만의 특별한 조리방식은 현대인의 건강 트렌드에 부합하며, 
                식재료 본연의 맛과 영양을 지키는 조리 철학을 바탕으로 보다 건강하고 안심할 수 있는 음식을 제공합니다.
              </p>
              <p>
                또한, OM FOOD는 단순한 프랜차이즈를 넘어 K-푸드의 글로벌화를 선도하는 브랜드로 나아가고 있습니다. 
                한국의 전통적인 식재료와 조리법에 현대적인 감각을 더해 전 세계 소비자들에게 새로운 식문화의 경험을 제안합니다.
              </p>
              <p>
                세계 여러 나라의 식문화와 고객의 입맛을 연구하고, 이를 반영한 현지 맞춤형 메뉴와 서비스로 
                글로벌 외식시장에서의 경쟁력을 확보해 나가고 있습니다.
              </p>
              <p>
                OM FOOD는 앞으로도 건강한 재료, 정직한 조리, 감동 있는 서비스로 고객의 신뢰를 쌓아가며 
                K-푸드를 대표하는 글로벌 외식 브랜드로 성장해가겠습니다.
              </p>
              <p style={{ 
                fontWeight: '600', 
                color: '#1f2937', 
            ...
            <div style={{ display: 'flex', justifyContent: 'center' }}>
              ...
              >
                <img 
                  src={getImagePath('OM_E5.jpg')}
                  alt="Herbs and vegetables illustration" 
                  style={{
                    width: '24rem',
                    height: '24rem',
                    objectFit: 'cover',
